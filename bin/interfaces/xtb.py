...
class xtb_methods():
    available_methods = ['GFN2-xTB']
    
    def __init__(self, method='GFN2-xTB', read_keywords_from_file=''):
        self.method = method
    ...
    def predict(self, molecular_database=None, molecule=None,
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            for mol in molDB.molecules:
                ...
                #if mol.charge != 0: xtbargs += ['--charg', '%d' % mol.charge] # there is a bug in xtb - it does not read --charg
                number_of_unpaired_electrons = mol.multiplicity - 1
                #xtbargs += ['--uhf', '%d' % number_of_unpaired_electrons] # there is a bug in xtb - it does not read --uhf
