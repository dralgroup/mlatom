...
class ANICls(object):
        ...
        def convert(fileout, setname, yorgrad=False):
            ...
            with open(coordfile ,'r') as fxyz:
                ...
                for line in fxyz:
                    ...
                    natom = int(line)
                    if args.ygradxyzfile and yorgrad: ngrad=int(fgrad.readline())
                    ...
                    for i in range(natom):
                        ...
                        if args.ygradxyzfile and yorgrad and ngrad: 
                    ...
                    if args.ygradxyzfile and yorgrad: 
                        if ngrad: data['forces'] = data['forces'].reshape(-1,natom,3)
                        else: 
                            data['forces'] = np.zeros((1,natom,3))
                            data['forces'][:]=np.nan
    ...
    def useMLmodel(cls, argsANI, subdatasets):
        ...
        if args.ani1x or args.ani2x or args.ani1ccx or args.ani1xd4 or args.ani2xd4:
            cls.dataConverted = True
