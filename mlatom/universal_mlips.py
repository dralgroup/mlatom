...
# name to a DIFFERENT functional, wB97X-D4 of Najibi and Goerigk. So `-f wb97x`
# silently changed meaning: s8 went -0.07519516 -> 0.5093, a1 0.45094893 ->
# 0.0662, a2 6.78425255 -> 5.4487. The models here were built against the 2008
# functional, because ANI-1x and ANI-2x are trained on wB97X/6-31G* data and this
# term was chosen to match, so on dftd4 >= 4.0.0 they were getting another
# functional's damping.
#
...
composition = {
    ...
    'aiqm3':      {'baseline': 'GFN2-xTB*', 'dispersion': {'method': 'd3bj', 'functional': 'b973c'}, 'atomic_shift': False},
    'aiqm3@dft':  {'baseline': 'GFN2-xTB*', 'dispersion': {'method': 'd3bj', 'functional': 'b973c'}, 'atomic_shift': False},
